		...
		if (rec_num >= header_pass_rec.first_id) {
			...
			while (choice != 0) {
				...
				case 2:
					...
					scanf_s("%u", &passeng_rec.origin.street);
					break;

				case 3:
					printf("Enter the new Orig avenue -> ");
					scanf_s("%u", &passeng_rec.origin.avenue);
					break;

				case 4:
					printf("Enter the new Orig puc -> ");
					scanf_s("%u", &passeng_rec.pick_up_corner);
					break;

				case 5:
					printf("Enter the new dest street -> ");
					scanf_s("%u", &passeng_rec.destination.street);
					break;

				case 6:
					printf("Enter the new dest avenue -> ");
					scanf_s("%u", &passeng_rec.destination.avenue);
					break;

				case 7:
					printf("Enter the new drop-of-corner -> ");
					scanf_s("%u", &passeng_rec.drop_off_corner);
					break;
